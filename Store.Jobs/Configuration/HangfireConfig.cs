...
namespace PDS.WITSMLstudio.Store.Jobs.Configuration
{
    ...
    public static class HangfireConfig
    {
        ...
        public static void Register(IContainer container)
        {
            ...
            RecurringJob.AddOrUpdate<ObjectGrowingManager>(ObjectGrowingManager.JobId, x => x.Start(), string.Format("{0} * * * *", changeDetectionPeriod));// Cron.MinuteInterval(changeDetectionPeriod));
        }
